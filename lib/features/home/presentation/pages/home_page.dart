...
import 'package:piv_app/features/profile/presentation/pages/profile_page.dart'; // Import ProfilePage
        ...
        itemBuilder: (context, index) {
          ...
          return SizedBox(
            ...
            child: Card(
              ...
              child: InkWell(
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Mở danh mục: ${category.name}'))),
              ...
              children: [
                Expanded(
                  ...
                  child: (product.imageUrls.isNotEmpty)
                    ...
                    fit: BoxFit.cover,
                    errorBuilder: (context, error, stackTrace) => Container(color: Colors.grey.shade200, alignment: Alignment.center, child: const Icon(Icons.image_search_outlined, size: 50, color: Colors.grey)),
                  )
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(currencyFormatter.format(product.displayPrice), style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(
              article.title,
              style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, height: 1.3),
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
            ),
            subtitle: Padding(
              ...
              child: Text(
                ...
                maxLines: 3,
                overflow: TextOverflow.ellipsis,
                style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.grey.shade700, height: 1.4),
              ),
            ),
